...
- [x] Handle repeated events
  - [x] Basic repeated events
  - [x] Punching holes
  - [x] Modifications of one event
  - [x] Modifications of all future events
...
- [x] Allow saving and loading Epics & Options to/from a file
  - [x] Handle errors when loading
